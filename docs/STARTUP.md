...
| 9 | `python3 tools/export_player_tables.py` | `player_clip_rates.emcr` | R | 0015BA50's clip-rate worker (em_player_stage_live, since L01; a missing file latches a scene fault at 0x0015BA50) |
