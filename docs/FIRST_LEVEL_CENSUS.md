...
| 0x001B0FD0 | — | BM | live | em_crate_original / em_drum_original state 0 (001B0EA0, bone_init, +4 += 1) — test_crate_original_reference.py, test_drum_original_reference.py |  | S2_opening* |
...
| 0x00175640 | — | BM | verified-unbound | em_actor_collision (em_player_link_00175640) — test_player_floor_reference | bound since the Boxes step (FLOOR engaged); first reached at 06_hill_slide, beyond the live smoke | 06_hill_slide |
...
| 0x00179450 | — | BM | verified-unbound | em_player_floor.c fall check (gated) — test_player_floor_reference | bound since the Boxes step (FLOOR engaged); first reached at 06_hill_slide, beyond the live smoke | 06_hill_slide |
...
| 0x0017B490 | — | BM | live | em_locomotion_display em_loco_0017B490 over the exported D_00248AB0 rows (the stage callees' clip lookup, 0017C440 / 00174A50) — test_locomotion_display_reference | em_player_frame.c loco_clip_for_tier still serves the port's idle / walk (L12) | S2_opening |
...
54 functions, 4,292 instructions: live 28, verified-unbound 26.
...
18 functions, 2,117 instructions: live 5, verified-unbound 12, unverified 1.
...
25 functions, 3,097 instructions: live 8, verified-unbound 16, stand-in 1.
...
| 0x0021B9A0 | — | NM | verified-unbound | em_packet_chain_original em_packet_chain_0021B9A0 (from the .s and its jump table) — test_packet_chain_reference.py | no live caller binds it: the frame head 001D1C50 (L32), the effects (001EA240, 001F0A60, 001F5940), the area script and 001E67C0 (em_snow_runtime keeps its own fog constants) | S0_title |
